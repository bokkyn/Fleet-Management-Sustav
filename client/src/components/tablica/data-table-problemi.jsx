        ...
        <div className="flex mr-3 ml-3 h-9 px-5 w-full rounded-md border border-input bg-transparent py-1 text-base shadow-sm transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring">
          <RadioGroup value={statusFilter} onValueChange={handleStatusChange}>
            <div className="flex items-center space-x-4 w-full">
              ...
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="Otvoreno" id="option-rejected" />
                <Label htmlFor="option-rejected">Otvoreno</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="Zatvoreno" id="option-canceled" />
                <Label htmlFor="option-canceled">Zatvoreno</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="U tijeku" id="option-approved" />
                <Label htmlFor="option-approved">U tijeku</Label>
              </div>
            </div>
          </RadioGroup>
        </div>
