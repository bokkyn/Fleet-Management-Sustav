...
function j(n3, u5, t4, i5, r4, o4, e4, f5, c4, s5) {
  var a4, h4, p5, v5, y4, g5, m3, b3, C3, S2, M2, P4, I2, A4, H3, L2, T4, F4 = u5.type;
  if (void 0 !== u5.constructor) return null;
  128 & t4.__u && (c4 = !!(32 & t4.__u), o4 = [f5 = u5.__e = t4.__e]), (a4 = l.__b) && a4(u5);
  n: if ("function" == typeof F4) try {
    if (b3 = u5.props, C3 = "prototype" in F4 && F4.prototype.render, S2 = (a4 = F4.contextType) && i5[a4.__c], M2 = a4 ? S2 ? S2.props.value : a4.__ : i5, t4.__c ? m3 = (h4 = u5.__c = t4.__c).__ = h4.__E : (C3 ? u5.__c = h4 = new F4(b3, M2) : (u5.__c = h4 = new x(b3, M2), h4.constructor = F4, h4.render = B), S2 && S2.sub(h4), h4.props = b3, h4.state || (h4.state = {}), h4.context = M2, h4.__n = i5, p5 = h4.__d = true, h4.__h = [], h4._sb = []), C3 && null == h4.__s && (h4.__s = h4.state), C3 && null != F4.getDerivedStateFromProps && (h4.__s == h4.state && (h4.__s = w({}, h4.__s)), w(h4.__s, F4.getDerivedStateFromProps(b3, h4.__s))), v5 = h4.props, y4 = h4.state, h4.__v = u5, p5) C3 && null == F4.getDerivedStateFromProps && null != h4.componentWillMount && h4.componentWillMount(), C3 && null != h4.componentDidMount && h4.__h.push(h4.componentDidMount);
    else {
      if (C3 && null == F4.getDerivedStateFromProps && b3 !== v5 && null != h4.componentWillReceiveProps && h4.componentWillReceiveProps(b3, M2), !h4.__e && (null != h4.shouldComponentUpdate && false === h4.shouldComponentUpdate(b3, h4.__s, M2) || u5.__v == t4.__v)) {
      ...
      null != h4.componentWillUpdate && h4.componentWillUpdate(b3, h4.__s, M2), C3 && null != h4.componentDidUpdate && h4.__h.push(function() {
        h4.componentDidUpdate(v5, y4, g5);
      });
    }
    if (h4.context = M2, h4.props = b3, h4.__P = n3, h4.__e = false, I2 = l.__r, A4 = 0, C3) {
      for (h4.state = h4.__s, h4.__d = false, I2 && I2(u5), a4 = h4.render(h4.props, h4.state, h4.context), H3 = 0; H3 < h4._sb.length; H3++) h4.__h.push(h4._sb[H3]);
      h4._sb = [];
    } else do {
      h4.__d = false, I2 && I2(u5), a4 = h4.render(h4.props, h4.state, h4.context), h4.state = h4.__s;
    } while (h4.__d && ++A4 < 25);
    h4.state = h4.__s, null != h4.getChildContext && (i5 = w(w({}, i5), h4.getChildContext())), C3 && !p5 && null != h4.getSnapshotBeforeUpdate && (g5 = h4.getSnapshotBeforeUpdate(v5, y4)), f5 = $(n3, d(L2 = null != a4 && a4.type === k && null == a4.key ? a4.props.children : a4) ? L2 : [L2], u5, t4, i5, r4, o4, e4, f5, c4, s5), h4.base = u5.__e, u5.__u &= -161, h4.__h.length && e4.push(h4), m3 && (h4.__E = h4.__ = null);
  } catch (n4) {
...
function N(u5, t4, i5, r4, o4, e4, f5, c4, s5) {
  ...
  if (null === x3) b3 === k3 || c4 && u5.data === k3 || (u5.data = k3);
    ...
    else if (v5 && (u5.innerHTML = ""), $(u5, d(y4) ? y4 : [y4], t4, i5, r4, "foreignObject" == x3 ? "http://www.w3.org/1999/xhtml" : o4, e4, f5, e4 ? e4[0] : i5.__k && C(i5, 0), c4, s5), null != e4) for (a4 = e4.length; a4--; ) _(e4[a4]);
...
function Y(n3) {
  ...
  } }), D(g(Z, { context: e4.context }, n3.__v), e4.v);
}
function $2(n3, e4) {
  var r4 = g(Y, { __v: n3, h: e4 });
  ...
  "string" == typeof n3.type && function(n4) {
    ...
    for (var i5 in t4) {
      ...
      if (!("value" === i5 && "defaultValue" in t4 && null == c4 || Q && "children" === i5 && "noscript" === e4 || "class" === i5 || "className" === i5)) {
        ...
        "defaultValue" === i5 && "value" in t4 && null == t4.value ? i5 = "value" : "download" === i5 && true === c4 ? c4 = "" : "translate" === l5 && "no" === c4 ? c4 = false : "o" === l5[0] && "n" === l5[1] ? "ondoubleclick" === l5 ? i5 = "ondblclick" : "onchange" !== l5 || "input" !== e4 && "textarea" !== e4 || X(t4.type) ? "onfocus" === l5 ? i5 = "onfocusin" : "onblur" === l5 ? i5 = "onfocusout" : J2.test(i5) && (i5 = l5) : l5 = i5 = "oninput" : o4 && G2.test(i5) ? i5 = i5.replace(K, "-$&").toLowerCase() : null === c4 && (c4 = void 0), "oninput" === l5 && u5[i5 = l5] && (i5 = "oninputCapture"), u5[i5] = c4;
      }
    }
...
function p4(n3) {
  ...
  var e4 = T2(function() {
    ...
    r4.__$u.c = function() {
      var n5, t4 = r4.__$u.S(), f6 = e4.value;
      t4();
      if (t(f6) || 3 !== (null == (n5 = r4.base) ? void 0 : n5.nodeType)) {
        r4.__$f |= 1;
        r4.setState({});
...
function MonthViewWeek({ week }) {
  ...
  return u2(k, { children: u2("div", { "data-testid": DATE_PICKER_WEEK, className: "sx__date-picker__week", children: weekDays.map((weekDay) => u2("button", { tabIndex: hasFocus(weekDay) ? 0 : -1, disabled: !isDateSelectable(weekDay.day), "aria-label": getLocalizedDate($app.datePickerState.datePickerDate.value, $app.config.locale.value), className: weekDay.classes.join(" "), "data-focus": hasFocus(weekDay) ? "true" : void 0, onClick: () => selectDate(weekDay.day), onKeyDown: handleKeyDown, children: weekDay.day.getDate() })) }) });
}
...
function YearsViewAccordion({ year, setYearAndMonth, isExpanded, expand }) {
  ...
  return u2(k, { children: u2("li", { className: isExpanded ? "sx__is-expanded" : "", children: [u2("button", { className: "sx__date-picker__years-accordion__expand-button sx__ripple--wide", onClick: () => expand(year), children: year }), isExpanded && u2("div", { className: "sx__date-picker__years-view-accordion__panel", children: yearWithDates.map((month) => u2("button", { className: "sx__date-picker__years-view-accordion__month", onClick: (event) => handleClickOnMonth(event, month), children: toLocalizedMonth(month, $app.config.locale.value) })) })] }) });
}
...
function CalendarHeader() {
  ...
  return u2("header", { className: "sx__calendar-header", "data-ccid": headerContentId, children: !headerContent && u2(k, { children: [u2("div", { className: "sx__calendar-header-content", children: [headerContentLeftPrependId && u2("div", { "data-ccid": headerContentLeftPrependId }), u2(TodayButton, {}), u2(ForwardBackwardNavigation, {}), u2(RangeHeading, {}, $app.config.locale.value), headerContentLeftAppendId && u2("div", { "data-ccid": headerContentLeftAppendId })] }), u2("div", { className: "sx__calendar-header-content", children: [headerContentRightPrependId && u2("div", { "data-ccid": headerContentRightPrependId }), $app.config.views.value.length > 1 && u2(ViewSelection, {}, keyForRerenderingOnLocaleChange + "-view-selection"), u2(AppWrapper, { "$app": datePickerAppSingleton }), headerContentRightAppendId && u2("div", { "data-ccid": headerContentRightAppendId })] })] }) });
}
...
var CalendarApp = class {
  ...
  render(el) {
    D(g(CalendarWrapper, { $app: this.$app }), el);
  }
  setTheme(theme) {
...
var PreactView = class {
  ...
  render(onElement, $app) {
    D(g(this.Component, { $app, id: this.randomId }), onElement);
  }
  destroy() {
...
function TimeAxis() {
  ...
  return u2(k, { children: u2("div", { className: "sx__week-grid__time-axis", children: hours.map((hour) => u2("div", { className: "sx__week-grid__hour", children: u2("span", { className: "sx__week-grid__hour-text", children: formatter.format(new Date(0, 0, 0, hour)) }) })) }) });
}
function DateAxis({ week }) {
  ...
  return u2(k, { children: u2("div", { className: "sx__week-grid__date-axis", children: week.map((date) => u2("div", { className: getClassNames(date), "data-date": toDateString$1(date), children: [u2("div", { className: "sx__week-grid__day-name", children: getDayNameShort(date, $app.config.locale.value) }), u2("div", { className: "sx__week-grid__date-number", children: date.getDate() })] })) }) });
}
...
function MonthGridDay({ day, isFirstWeek, isLastWeek }) {
  ...
  }, children: [fullDayBackgroundEvent && u2(k, { children: u2("div", { className: "sx__month-grid-background-event", title: fullDayBackgroundEvent.title, style: {
    ...fullDayBackgroundEvent.style
...
//# sourceMappingURL=chunk-GVDHTBAB.js.map
